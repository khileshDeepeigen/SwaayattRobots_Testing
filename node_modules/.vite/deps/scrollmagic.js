    ...
    (function(root, factory) {
      ...
      var _util = ScrollMagic._util = function(window2) {
        ...
        U.log = function(loglevel) {
          ...
          var now = /* @__PURE__ */ new Date(), time = ("0" + now.getHours()).slice(-2) + ":" + ("0" + now.getMinutes()).slice(-2) + ":" + ("0" + now.getSeconds()).slice(-2) + ":" + ("00" + now.getMilliseconds()).slice(-3), method2 = loglevels[loglevel - 1], args = Array.prototype.splice.call(arguments, 1), func = Function.prototype.bind.call(console[method2], console);
          args.unshift(time);
...
export default require_ScrollMagic();
