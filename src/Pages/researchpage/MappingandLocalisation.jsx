...
const MappingandLocalisation = () => {
  ...
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_SERVER_URL}/research`)
      .then(response => {
        const demonstration1Data = response.data.demonstration2;
        setVideoData(demonstration1Data);
      console.log(demonstration1Data,'this is demo1deta')
      })
      .catch(error => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const rows = document.querySelectorAll('.onroad_video-row');
      rows.forEach((row) => {
    ...
    <div>
      <div className="videocard-container">
        <div className="videocard-header">
          <h1 className="videocard-title">Mapping and Localisation</h1>
...
export default MappingandLocalisation;
