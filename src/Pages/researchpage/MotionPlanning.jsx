...
const MotionPlanning = () => {
  ...
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_SERVER_URL}/research`)
      .then(response => {
        const demonstration1Data = response.data.demonstration1;
        console.log("data:", response.data.demonstration1)
    ...
    <div>
      <div className="videocard-container">
        <div className="videocard-header">
          <h1 className="videocard-title">Motion Planning and Decision Making</h1>
